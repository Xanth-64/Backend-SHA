...
from src.routes.page.page_blueprint import (
...
def create_blueprints(db: SQLAlchemy, models, schemas, app: Flask) -> None:
    ...
    app.register_blueprint(blueprint=create_page_blueprint(db, models, schemas))
    app.register_blueprint(
        blueprint=create_practice_test_blueprint(db, models, schemas)
    )
    app.register_blueprint(blueprint=create_role_blueprint(db, models, schemas))
    app.register_blueprint(blueprint=create_template_blueprint(db, models, schemas))
    app.register_blueprint(
        blueprint=create_test_question_blueprint(db, models, schemas)
    )
    app.register_blueprint(blueprint=create_topic_blueprint(db, models, schemas))
    app.register_blueprint(blueprint=create_user_blueprint(db, models, schemas))
